...
def generate_bot_keys(count: int = 100) -> None:
    ...
    print(f"\n✅ Successfully generated {count} bot keys!")
    print(f"📁 Saved to: {env_keys_file}")
    print(f"\n⚠️  IMPORTANT: Keep {env_keys_file} secure and NEVER commit it to git!")
    print(f"Add to your .gitignore if not already present.")
